...
if(PUGIXML_DOWNLOAD_ARCHIVE)
	...
	if (IS_DIRECTORY ${CMAKE_BINARY_DIR}/${PUGIXML_SOURCE_DIR_NAME})
		target_include_directories(${PACKAGE_EXE_NAME} PRIVATE ${CMAKE_BINARY_DIR}/${PUGIXML_SOURCE_DIR_NAME}/src)
		target_sources(${PACKAGE_EXE_NAME} PRIVATE ${CMAKE_BINARY_DIR}/${PUGIXML_SOURCE_DIR_NAME}/src/pugixml.cpp)
